...
#[CoversClass(NotEqualToCommand::class)]
class NotEqualToCommandTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->commandTester = new CommandTester(new NotEqualToCommand());
    }

    #[DataProviderExternal(ComparatorTest::class, 'notEqualToProvider')]
