...
#[CoversClass(LessThanOrEqualToCommand::class)]
class LessThanOrEqualToCommandTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->commandTester = new CommandTester(new LessThanOrEqualToCommand());
    }

    #[DataProviderExternal(ComparatorTest::class, 'lessThanOrEqualToProvider')]
